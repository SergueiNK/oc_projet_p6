...
-- -----------------------------------------------------
-- Table `OCPizza`.`PizzaOrder`
-- -----------------------------------------------------
CREATE TABLE `PizzaOrder` (
  `id_pizza_order` INT NOT NULL,
  `pizza_name_fk` VARCHAR(50) NOT NULL,
  `id_order_fk` INT NOT NULL,
  `pizza_quantity` INT NOT NULL,
  PRIMARY KEY (`id_pizza_order`),
  CONSTRAINT `id_pizza_order`
    FOREIGN KEY (`pizza_name_fk`)
    REFERENCES `Pizza` (`pizza_name`)
	ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `id_order_fk`	
    FOREIGN KEY (`id_order_fk`)
    REFERENCES `CustomerOrder` (`id_order`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
-- -----------------------------------------------------
-- Table `OCPizza`.`RestaurantInventory`
-- -----------------------------------------------------
CREATE TABLE `RestaurantInventory` (
  `id_restaurant_inventory` INT NOT NULL,	
  `ingredient_name_inventory_fk` VARCHAR(50) NOT NULL,
  `id_restaurant_number_fk` INT NOT NULL,
  `ingredient_inventory` INT NULL,
  `unit_ingredient` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`id_restaurant_inventory`),
  CONSTRAINT `ingredient_name_inventory_fk`
    FOREIGN KEY (`ingredient_name_inventory_fk`)
    REFERENCES `Ingredient` (`ingredient_name`)
	ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `id_restaurant_number_fk`	
    FOREIGN KEY (`id_restaurant_number_fk`)
    REFERENCES `Restaurant` (`id_restaurant_number`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
